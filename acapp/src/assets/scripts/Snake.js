...
export class Snake extends AcGameObject {
    ...
    render() {
        ...
        ctx.fillStyle = "black";
        for (let i = 0; i < 2; i++) {
            const eye_x = (this.cells[0].x + this.eye_dx[this.eye_directrion][i] * 0.15) * L;
            const eye_y = (this.cells[0].y + this.eye_dy[this.eye_directrion][i] * 0.15) * L;
            ctx.beginPath();
