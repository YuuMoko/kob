                ...
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                            data-bs-target="#add-bot-btn">Create Bot</button>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input v-model="botadd.title" type="text" class="form-control"
                                                id="add-bot-title" placeholder="Please enter bot name">
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" :id="'update-bot-modal-' + bot.id"  tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title fs-5">Edit Bot</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal" @click="refresh_bots">Cancel</button>
                                                    </div> 
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app6077.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            botadd.error_message = "",
                $.ajax({
                    url: "https://app6077.acapp.acwing.com.cn/api/user/bot/add/",
                    type: "post",
                    data: {
                        title: botadd.title,
        ...
        const update_bot = (bot) => {
            botadd.error_message = "",
                $.ajax({
                    url: "https://app6077.acapp.acwing.com.cn/api/user/bot/update/",
                    type: "post",
                    data: {
                        bot_id: bot.id,
                        title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app6077.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
